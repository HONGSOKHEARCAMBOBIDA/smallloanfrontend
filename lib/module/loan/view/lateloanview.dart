...
class Lateloanview extends StatefulWidget {
  const Lateloanview({super.key});

  @override
  State<Lateloanview> createState() => _LateloanviewState();
}

class _LateloanviewState extends State<Lateloanview> {
  ...
  void _onScroll() {
    if (_scrollController.position.pixels ==
        ...
        loancontroller.hasMoreLateLoan.value &&
        !loancontroller.isLoadingMoreLateloan.value &&
        !loancontroller.isLoadinglateloan.value) {
      _loadMore();
    }
  }

  Future<void> _loadMore() async {
    await loancontroller.loadMoreLateLoan();
  }

  Future<void> refresh() async {
    searchQuery.clear();
    loancontroller.searchQueryLateloan.value = '';
    await loancontroller.getlateloan(isRefresh: true);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: "បញ្ជីកម្ចីយឺត"),
      body: Stack(
        ...
        children: [
          RefreshIndicator(
            ...
            onRefresh: refresh,
            child: Obx(() {
              if (loancontroller.isLoadinglateloan.value &&
                                    ...
                                    ? Expanded(
                                        child: SizedBox(
                                          ...
                                          child: CustomTextField(
                                            ...
                                            onChanged: (value) {
                                              loancontroller.searchQueryLateloan
                                                  .value = value;
                                            },
                                          ),
                                        ),
