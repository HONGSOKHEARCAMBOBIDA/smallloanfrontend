...
class Updateclientview extends StatefulWidget {
  final Data clientmodel;
  const Updateclientview({super.key, required this.clientmodel});

  @override
  State<Updateclientview> createState() => _UpdateclientviewState();
}

class _UpdateclientviewState extends State<Updateclientview> {
  ...
  void _initializeData() {
    ...
    selectprovinceid.value = client.provinceId;
    selectdistrictid.value = client.districtId;
    selectcommunceid.value = client.communceId;
    selectvillageid.value = client.villageId;
    namecontroller.text = client.name!;
    selectgender.value = client.gender!;
    maritalStatus.text = client.maritalStatus!;
    if (client.dateOfBirth != null) {
      selectdob.value = CustomDateUti.parseDate(client.dateOfBirth);
    }
    occupationcontroller.text = client.occupation!;
    idCardNumbercontroller.text = client.idCardNumber!;
    phonecontroller.text = client.phone!;
    if (client.provinceName != null) {
      selectprovincename.value = client.provinceName!;
    }
    if (client.districtName != null) {
      selectdistrictname.value = client.districtName!;
    }
    if (client.communceName != null) {
      selectcommuncename.value = client.communceName!;
    }
    if (client.villageName != null) {
      selectvillagename.value = client.villageName!;
    }
  ...
  void _loadaddress() {
    ...
    if (widget.clientmodel.provinceId != null) {
      districtcontroller.fetchdistrict(widget.clientmodel.provinceId!);
    }
    if (widget.clientmodel.districtId != null) {
      communcecontroller.fetchcommunce(widget.clientmodel.districtId!);
    }
    if (widget.clientmodel.communceId != null) {
      villagecontroller.fetvillage(widget.clientmodel.communceId);
    }
  }
